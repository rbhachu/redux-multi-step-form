...
function FormUserPrivacy({ pageName, submitButtonText, previousButton }) {
  ...
  const [formData, setFormData] = useState({
    ...
    signup1: stateSignup1 === "yes" ? "yes" : "no",
    signup2: stateSignup2 === "yes" ? "yes" : "no"
  ...
  const handleChange1 = (e) => {  
    ...
    isChecked1 === "yes" ? setFormData({signup1: "yes" }) : setFormData({signup1: "no" })
  }
  const handleChange2 = (e) => {
    setIsChecked2(!isChecked2);
    isChecked2 === "yes" ? setFormData({signup2: "yes" }) : setFormData({signup2: "no" })
  }
